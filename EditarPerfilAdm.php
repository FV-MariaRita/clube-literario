          ...
          <li class="col-sm-2">
            ...
            <div id="mySidenav2" class="sidenav">
                ...
                <a href="PaginaDePerfilAdm.php?id=<?php echo $_SESSION['id'];?>"><?php 
                  ...
                  ?></a><br>
                <p class="quicksand-regular2"><?php echo $nome; ?></p><br>
              ...
              <button class="btn btn-outline-success" type="submit"><img id="BotaoPesquisa" src="./images/SearchIcon1.png"></button>
                ...
                <a class="quicksand-regular2" href="ExcluirPerfilAdm.php?id=<?php echo $id; ?>">Excluir Perfil</a><br><br>
    ...
    <div class="row">
        <div class="col-xl-8">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form method="post" action="alterarperfil.php?id=<?php echo $id; ?>" enctype="multipart/form-data">                    
                            <div class="mb-3">
                        ...
                        <div class="row gx-3 mb-3">
                            <div class="mb-3">
                                <label class="quicksand-regular2" for="header">Header (insira o link da imagem no campo abaixo):</label><br><br>
                                <img id="headerUserUp" src=".images/Harry Potter banner.png"><br><br>
                                <input type="text" class="btn btn-primary" name="novaHeader" id="header"></button>
                            </div>
                        </div>
                        
                    <br>
                        <div id="cardHeaderProfile" class="card-header"><h4 class=quicksand-regular>Foto de Perfil (somente na extensão .png)</h4></div>
