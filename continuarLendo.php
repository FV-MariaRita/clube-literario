    ...
    <nav class="container-fluid">
        <ul class="row">
          ...
          <li class="col-sm-2">
            ...
            <li class="col-sm-2">
              <a class="nav-link" href="PaginaDePerfil.php?id=<?php echo $_SESSION['id']; ?>" role="button">
                Página de perfil
              </a>
            </li>
          <!--Botão para abrir a nav lateral-->
            ...
            <div id="mySidenav2" class="sidenav">
                ...
                <a href="PaginaDePerfil.php?id=<?php echo $_SESSION['id']; ?>"><img id="ProfilePicNav" src="./images/profile picture.jpg" class="rounded-circle me-3" alt="User Avatar"></a><br>
                ...
                <a class="quicksand-regular2" href="EditarPerfil.php?id=<?php echo $_SESSION['id']; ?>">Editar Perfil</a><br><br>
                ...
                <div class="col-lg-3">
                  <div id="cardLivro" class="card" style="width: 15rem;">
                    ...
                    <div class="card-body">
                      ...
                      <a href="PáginasDeLeituraLivro.php?id=<?php echo $id; ?>" class="btn btn-primary">Continuar lendo</a>
                    </div>
                  </div>
                </div>
                <?php 
